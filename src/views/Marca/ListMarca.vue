<template >
  ...
  <div class="container">
    <div class="d-flex justify-center align-items-center bg-dark">
      <h2 class="col-10 display-3 custom-text-color " >Marcas</h2>
      <div class="col-2">
        <router-link to="/AddMarca" class="btn btn-success  " >
    ...
    <table class="table table-bordered table-dark">
      ...
      <tbody>
        ...
        <tr scope="row" v-for="item in marcasList" :key="item.id">
          ...
          <td>
            <router-link class="btn btn-editar" :to="{ name: 'AddMarca', query: { id: item.id, form: 'editar' } } ">
          ...
          <td >
            <router-link class="btn btn-excluir " :to="{ name: 'AddMarca', query: { id: item.id, form: 'excluir' } } ">
