<template >
    ...
    <div class="container">
      <div class="d-flex justify-center align-items-center bg-dark">
        <h2 class="col-10 display-3 custom-text-color " >Veiculos</h2>
        <div class="col-2">
          <router-link to="/AddVeiculo" class="btn btn-success  " >
        ...
        <tbody>
          ...
          <tr v-for="veiculo in veiculoLista" :key="veiculo.id" scope="row">
            ...
            <td>
              ...
              <router-link class="btn btn-editar" :to="{ name: 'EditarVeiculo', query: { id: veiculo.id, form: 'editar' } } ">
            ...
            <td >
              <router-link class="btn btn-excluir" :to="{ name: 'ExcluirVeiculo', query: { id: veiculo.id, form: 'excluir' } } ">
