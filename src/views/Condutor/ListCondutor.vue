<template>
    ...
    <div class="container">
          <div class="d-flex justify-center align-items-center bg-dark">
            <h2 class="col-10 display-3 custom-text-color " >Condutores</h2>
            <div class="col-2">
          ...
          <table class="table table-bordered table-dark">
            ...
            <tbody>
              ...
              <tr v-for="Condutor in condutorLista" :key="Condutor.id" scope="row">
                ...
                <td>
                  <router-link class="btn btn-EditarCondutor" :to="{ name: 'Adicionar-Condutor-editar', query: { id: Condutor.id, form: 'editar' } } ">
                ...
                <td >
                  <router-link class="btn btn-ExcluirCondutor" :to="{ name: 'Adicionar-Condutor-excluir', query: { id: Condutor.id, form: 'excluir' } } ">
